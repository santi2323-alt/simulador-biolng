...
st.markdown(f"""
<style>
    @import url('https://fonts.googleapis.com/css2?family=Barlow:wght@400;500;600;700;800&family=Barlow+Semi+Condensed:wght@600;700;800&display=swap');
    ...
    * {{ font-family: 'Barlow', 'Helvetica Neue', Arial, sans-serif !important; }}
    ...
    .ng-logo-text {{ color: #FFFFFF !important; font-family: 'Barlow Semi Condensed' !important;
    ...
    .ng-title {{ color: #FFFFFF !important; font-family: 'Barlow Semi Condensed' !important;
    ...
    section[data-testid="stSidebar"] h3 {{ color: #FFFFFF !important; font-family: 'Barlow Semi Condensed' !important; }}
    ...
    .ng-section-title {{ font-family: 'Barlow Semi Condensed' !important; font-size: 19px; font-weight: 700; color: {AZUL} !important; }}
    ...
    .kpi-value {{ font-family: 'Barlow Semi Condensed' !important; font-size: 32px; font-weight: 800; letter-spacing: -0.5px; line-height: 1.1; margin-top: 4px; }}
    ...
    .proc-val {{ font-family: 'Barlow Semi Condensed' !important; font-size: 14px; font-weight: 700; margin-top: 2px; }}
...
st.markdown(f"""
<div class="ng-topbar">
    <div class="ng-logo"><span class="ng-logo-mark"></span><span class="ng-logo-text">naturgy</span></div>
...
dico = "🚛" if es_biolng else "🔥"
st.markdown(f"""
<div class="proc-wrap">
    <div class="proc-step"><div class="proc-ico">🌾</div><div class="proc-name">Biomasa</div><div class="proc-val" style="color:{NARANJA};">{biomasa:.0f} t/d</div></div>
    <div class="proc-conn"><div class="proc-line" style="--c:{rc};"></div></div>
    <div class="proc-step"><div class="proc-ico">⚗️</div><div class="proc-name">Biodigestor</div><div class="proc-val" style="color:{rc};">{biomasa*0.9:.0f} t</div></div>
    <div class="proc-conn"><div class="proc-line"></div></div>
    <div class="proc-step"><div class="proc-ico">🏭</div><div class="proc-name">Upgrading</div><div class="proc-val" style="color:{rc};">{biometano_m3d:,.0f} m³/d</div></div>
    <div class="proc-conn"><div class="proc-line"></div></div>
    <div class="proc-step"><div class="proc-ico">{"❄️" if es_biolng else "🔀"}</div><div class="proc-name">{"Licuefacción" if es_biolng else "Bifurcación"}</div><div class="proc-val" style="color:{rc};">{biolng_m3d:,.0f} m³/d</div></div>
    <div class="proc-conn"><div class="proc-line"></div></div>
    <div class="proc-step"><div class="proc-ico">{dico}</div><div class="proc-name">{destino}</div><div class="proc-val" style="color:{NARANJA};">{clientes_diesel} clientes</div></div>
</div>
...
def gauge(value, title, vmin, vmax, color, ref=None):
    ind = dict(mode="gauge+number" + ("+delta" if ref is not None else ""), value=value,
        number={'font': {'size': 24, 'color': AZUL, 'family': 'Barlow Semi Condensed'}},
        title={'text': title, 'font': {'size': 11, 'color': GRIS_SUAVE, 'family': 'Barlow'}},
    ...
    if ref is not None:
        ind['delta'] = {'reference': ref, 'increasing': {'color': VERDE}, 'decreasing': {'color': ROJO}, 'font': {'size': 12, 'family': 'Barlow'}}
